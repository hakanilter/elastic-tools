...
**Elastic Tools** is an [Apache Spark](https://github.com/apache/spark) based command line tools designed to help scalable export / import support for ElasticSearch. 
